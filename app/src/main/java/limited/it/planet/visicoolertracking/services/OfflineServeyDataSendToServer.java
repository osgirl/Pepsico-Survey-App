...
/**
 * Created by Tarikul on 3/8/2018.
 */

public class OfflineServeyDataSendToServer {
    ...
    public OfflineServeyDataSendToServer(Context context){
        this.mContext = context;
        localStorageDB = new LocalStorageDB(mContext);
        isActiveOfflineDataActivity = SharedPreferenceLocalMemory.getBoleanValueSharedPreferences("is_active_offline",mContext);
            ...
            protected String doInBackground(String... params) {
                ...
                try{
                    ...
                    try {
                        ...
                        if(responseResult.equals("success")){
                                ...
                                if(outletId!=null && !outletId.isEmpty()){
                                    ...
                                    ((Activity)mContext).runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            //Toast.makeText(mContext, "Your Update Information Add Successfully To Server", Toast.LENGTH_LONG).show();
                                            openDialog("Your Data Upload Success");
                            ...
                            ((Activity)mContext).runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    loadingDialog.cancel();
                                    openDialog("Your Data Upload Failled ! Click Again");
                    ...
                    ((Activity)mContext).runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            loadingDialog.cancel();
                            openDialog("Your Data Upload Failled ! for Network Problem");
